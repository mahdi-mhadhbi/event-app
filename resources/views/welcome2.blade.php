                        ...
                        <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                            ...
                            @if (Route::has('login'))
                                    @auth
                                        ...
                                        <a href="{{ url('/admin/dashboard') }}" class="btn custom-btn d-lg-block d-none">Dashboard</a>
                                        
                                        @elseif (auth()->user()->role == 'client')
                                        <a href="" class="btn custom-btn d-lg-block d-none">Profile</a>
                                        @else
                                        <a href="{{ url('/organisateur/dashboard') }}" class="btn custom-btn d-lg-block d-none">Dashboard</a>
                                    ...
                                    @else
                                        <a href="{{ route('login') }}" class="btn custom-btn d-lg-block d-none">Log in</a>
            ...
            <section class="hero-section" id="section_1">
                ...
                <div class="video-wrap">
                    <video autoplay="" loop="" muted="" class="custom-video" poster="">
                        <source src="{{asset('event/video/pexels-2022395.mp4')}}" type="video/mp4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="about-text-wrap">
                                <img src="{{asset('event/images/pexels-alexander-suhorucov-6457579.jpg')}}" class="about-image img-fluid">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="{{asset('event/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg')}}" class="artists-image img-fluid">
                                </div>
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="{{asset('event/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg')}}" class="artists-image img-fluid">
                                </div>
                            ...
                            <div class="artists-thumb">
                                <img src="{{asset('event/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg')}}" class="artists-image img-fluid">
